...
When a user clicks on a product, it will lead them to the Individual Product page. There, users can see the product info, add to cart, and see reviews for that product. The counter to add to cart will not be less than one or more than 10. 
