...
######
The home page features a carousel. The first page of the carousel has a welcome message. If a user is not logged in, it will say "Welcome to B&K Fish Market". However, if they are logged in, it will say 'Welcome ${user_name}'. The second page of the carousel has the discount code for free shipping. The third page has a link to navigate the user to the About Us page.

<img width="100" alt="Screen Shot 2022-10-03 at 3 19 38 PM" src="https://user-images.githubusercontent.com/104730743/193691309-0a6f4c55-ba09-4411-9a20-5247adebead5.png">
...
Cart Items are stored in local storage. This way, users can view their cart even after they close their browser. Users can also remove individual items or remove all items from cart. If there are no items in the cart, it will state that. If there are items in the cart and the user is not logged in, it will prompt the user to log in. If the user is logged in, they can proceed check out.     
